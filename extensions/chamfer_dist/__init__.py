...
class ChamferDistanceL2_D1D2(torch.nn.Module):
    f''' Chamder Distance L2
    '''
    def __init__(self, ignore_zeros=False):
        super().__init__()
...
# class ChamferDistanceL2Weighted(torch.nn.Module):
#     f''' Chamder Distance L2 Weighted
#     '''
#     def __init__(self, ignore_zeros=False, ratio=1.5):
#         super().__init__()
#         self.ignore_zeros = ignore_zeros
#         self.ratio = ratio
#
...
#
#         dist1, dist2 = ChamferFunction.apply(xyz1, xyz2)
#         return torch.mean(dist1) + self.ratio*torch.mean(dist2)
