...
def main():
    ...
    if args.distributed:
        ...
        if config.dataset.get('ModelNet'):                                  #  Added By Maoz
            config.dataset.test.others.bs = config.total_bs // world_size   #  Added By Maoz
    else:
        ...
        if config.dataset.get('ModelNet'):                                 #  Added By Maoz
            config.dataset.test.others.bs = config.total_bs                #  Added By Maoz
    # log 
